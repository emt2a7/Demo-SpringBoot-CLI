...
public class Rag05Controller {
    private final Rag05Service service;
    ...
    public void run() {
        ...
        try {
            ...
            var inputFile = "測試資料_台灣總人口連26個月負成長.docx"; // 含圖片的 word 文件
            ...
            log.info("【相關程式】");
            log.info(" - Rag05Controller.run()");
            log.info(" - Rag05Service.updateBabyDocument()");
            log.info(" - Rag05Service.askWordImageToDescription()");
            log.info(" - Rag05Service.askTools()");
            ...
            log.info("【注意事項】");
            log.info(" - 允許上傳 word 文件，副檔名必須是 *.docx，且文件內可以包含圖片。");
            log.info(" - 允許重複上傳，後蓋前");
